          ...
          providers: [
            BlocProvider(
                create: (BuildContext context) =>
                    PermissonblocBloc(appPermission: AppPermission())
                      ..add(RequestAllPermission()))
          ],
          child: BlocConsumer<PermissonblocBloc, PermissonblocState>(
            listener: (context, state) {},
            builder: (context, state) {
              if (state is RequestAllPermissionLoaded) {
                return SafeArea(
